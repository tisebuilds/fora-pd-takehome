...
export const inlineSectionEmptyActionTriggerClass =
  "flex min-h-[52px] w-full items-center gap-2 border-0 bg-transparent py-3.5 pl-4 pr-4 text-left text-[15px] font-normal text-fora-navy outline-none transition-colors hover:bg-fora-app focus-visible:ring-2 focus-visible:ring-fora-navy/20 focus-visible:ring-inset";
