          ...
          >
            ...
            <div className="mt-6 flex justify-end">
              <Dialog.Close
                type="button"
                className={cn(
                  "inline-flex h-10 shrink-0 items-center justify-center rounded-md bg-black px-6 text-[15px] font-medium text-white outline-none transition-colors hover:bg-gray-800 focus-visible:ring-2 focus-visible:ring-fora-border/60",
                )}
              >
                Got it
              </Dialog.Close>
