...
export function ChoosePrototypeNavButton({ collapsed }: { collapsed: boolean }) {
  ...
  return (
    <button
      ...
      className={cn(
        "rounded-sm text-[13px] font-normal text-ink outline-none transition-opacity duration-200 hover:opacity-80 focus-visible:ring-2 focus-visible:ring-ink/25 focus-visible:ring-offset-2 focus-visible:ring-offset-paper",
        collapsed
